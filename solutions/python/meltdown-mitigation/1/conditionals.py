...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    total_threshold = (threshold * 90)/100
    min_total_threshold = threshold - ((threshold * 10)/100)
    max_total_threshold = threshold + ((threshold * 10)/100)

    if total < total_threshold:
        return 'LOW'
    elif total > min_total_threshold and total < max_total_threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
